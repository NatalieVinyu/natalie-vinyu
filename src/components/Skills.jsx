    ...
    <div id='skills' className='dark:bg-slate-950 dark:text-white scroll-smooth '>
      ...
      <section className='max-w-7xl mx-auto px-8 py-24'>
        ...
        <div className='flex flex-col items-center'>
          <h2 className='sm:text-2xl md:text-3xl font-bold'>Skills and Technologies</h2>
          <div className='w-25 h-1 mt-2 rounded-full bg-fuchsia-200'></div>
        </div>

      {/* SKILLS GRID */}
       <div className='grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-4 mt-4'>
